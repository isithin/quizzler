...
public class NamingQuizController {
	...
	/**
	 * Creates a new quiz with the entered name and switches to the
	 * selectQuestionType view. If no quizname is entered, an alert is shown. If the
	 * quizname already exists, an alert is shown. (Quiznames have to be unique to
	 * use them as id)
	 */
	@FXML
